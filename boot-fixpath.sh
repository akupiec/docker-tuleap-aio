...
[ ! -f localhost.key.pem ] && ln -s /data/etc/pki/tls/private/localhost.key localhost.key.pem

cd /etc/ssl/certs
[ ! -f localhost.crt ] && ln -s /data/etc/ssl/certs/localhost.crt localhost.crt
[ ! -f localhost.cert.pem ] && ln -s /data/etc/ssl/certs/localhost.crt localhost.cert.pem
